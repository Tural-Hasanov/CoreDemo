...
namespace CoreDemo.Areas.Admin.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public List<BlogModel> GetBlogList()
        {
            ...
            {
                new BlogModel{ID=1,BlogName="C# Programlamaya girish"},
                new BlogModel{ID=2,BlogName="Tesla Shirketinin Mashinlari"},
                new BlogModel{ID=3,BlogName="2020 Olimpiya Oyunlari"}
            };
            return bm;
        }
